...
Astrbot拥有知识库功能，但是需要配置 嵌入(Embedding)模型 所以我在安装脚本里提前放置了Ollama
...
在主页面左侧列表中点击 “模型提供商” ，选择 “嵌入(Embedding)” ，点击  “新建模型提供商” ，选择Ollama Embedding。

点击“保存”

### 配置知识库

在主页面左侧列表中点击 “知识库” ，点击 “创建知识库” ，填写名称和描述。嵌入模型选择 “nomic-embed-text”

### 完成

配置已经完成，可以直接在知识库>知识库名称>文档管理>上传文件。
